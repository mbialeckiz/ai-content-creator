...
PROMPT_REDAKTOR = (
    ...
    "BRIEF GRAFICZNY — jak go pisać\n"
    "Grafiki powstają w Canvie, nie w tej aplikacji, i mają swój ustalony "
    "kształt: pion 4:5, adres www.forces.no u góry, czarny pasek z logo na "
    "dole, złoto (#BBA470) jako jedyny akcent. Forces DC publikuje trzy "
    "formaty: KARUZELĘ (4–11 slajdów: karta z cytatem, ranking osób lub firm, "
    "zapowiedź wydarzenia), INFOGRAFIKĘ (jedna gęsta plansza — lista "
    "numerowana „5 kroków do…” albo trzy ramki „Key Points” z ikonami) oraz "
    "PROSTĄ PLANSZĘ Z HASŁEM.\n"
    "Wybierz format pasujący do tematu i napisz brief tak, żeby złożenie "
    "grafiki było odtwarzaniem gotowego opisu, a nie wymyślaniem układu. "
    "Przy karuzeli wypisz slajd po slajdzie, z tekstem na każdy. Przy "
    "infografice podaj nagłówek i treść każdej ramki. Nie pisz ogólników "
    "w rodzaju „grafika ilustrująca temat” — to nie jest brief.\n"
    "Wszystkie dotychczasowe grafiki Forces DC są po angielsku; teksty "
    "przeznaczone na obraz podawaj po angielsku, a resztę briefu po polsku.\n\n"
    ...
    "## Brief graficzny\n<opis dla operatorki składającej grafikę w Canvie — "
    "patrz zasady poniżej>\n\n"
